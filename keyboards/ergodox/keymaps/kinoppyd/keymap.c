...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LCTL,        KC_LGUI,      KC_LGUI,KC_LALT,KC_BSPC,
                                               KC_NO,  KC_NO,
                                                               KC_F5,
                                               KC_SPC, KC_SPC, KC_F6,
        // right hand
             ...
             KC_TAB,      KC_N,   KC_M,    KC_COMM,KC_DOT, KC_SLSH,  KC_SLSH,
                                  MO(MDIA),KC_NO  ,KC_LBRC,KC_RBRC,  KC_RALT,
             KC_F10,          KC_NO,
             KC_F8,
             KC_F7,  KC_ESC, KC_ENT
    ),
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, KC_TRNS,
                         KC_TRNS,KC_DOT,  KC_0,    KC_EQL,  KC_RALT,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
 ...
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      | RESET  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      |      |  Up  |      |      |      |           |      |MsLeft|MsDown| MsUp |MsRght|      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      | Left | Down | Right|      |------|           |------| Left | Down |  Up  | Rght |      |  Play  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |  Alt |      |                                       |      |VolDn | Mute | VolUp|  Alt |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
...
[MDIA] = KEYMAP(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_MPRV, KC_MNXT, KC_TRNS, KC_TRNS,
                          KC_TRNS, KC_VOLD, KC_MUTE, KC_VOLU, KC_RALT,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
